...
var adapter = GeocoderFactory.getGeocoder('openstreetmap', 'http', {language: "de", formatter : null, formatterPattern: '%P' });// clientId: 'foo',
	//apiKey: 'bogus'});
...
// 	console.log(res);
// });
adapter.geocode('Champs ', function(err, res) {
	console.log(err);
	console.log(res);
});
